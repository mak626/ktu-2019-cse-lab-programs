CREATE DATABASE  IF NOT EXISTS `mak_single_row` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `mak_single_row`;
-- MySQL dump 10.13  Distrib 8.0.27, for Win64 (x86_64)
--
-- Host: localhost    Database: mak_single_row
-- ------------------------------------------------------
...
-- Dump completed on 2022-01-13 15:06:25
